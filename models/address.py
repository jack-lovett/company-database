...
class Address(Base):
    ...
    address_postal_code = Column(String(4), nullable=False)
    address_country = Column(String(45), nullable=False)
    address_type = Column(Enum("billing_address", "postal_address", "shipping_address", "office_address"),
                          nullable=False)

    contacts_as_billing = relationship("Contact", foreign_keys="Contact.address_id", back_populates="billing_address",
                                       overlaps="contacts_as_billing")
    contacts_as_postal = relationship("Contact", foreign_keys="Contact.address_id", back_populates="postal_address",
                                      overlaps="contacts_as_billing")
