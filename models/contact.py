...
class Contact(Base):
    ...
    contact_phone = Column(String(45), nullable=True)
    contact_email = Column(String(45), nullable=True)
    contact_business_name = Column(String(45), nullable=True)
    contact_abn = Column(String(45), nullable=True)
    contact_acn = Column(String(45), nullable=True)
    contact_accounts_email = Column(String(45), nullable=True)
    contact_website = Column(String(45), nullable=True)
    contact_discipline = Column(String(45), nullable=True)
