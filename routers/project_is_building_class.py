...
from schemas.project_is_building_class import ProjectIsBuildingClass, ProjectIsBuildingClassCreate, ProjectIsBuildingClassUpdate
...
def update_project_is_building_class(project_is_building_class_id: int, obj: ProjectIsBuildingClassUpdate, database: Session = Depends(get_database)):
